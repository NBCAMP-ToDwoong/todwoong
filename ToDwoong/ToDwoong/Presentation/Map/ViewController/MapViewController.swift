...
//
//    private func updateMapAnnotations() {
//        mapView.mapView.removeAnnotations(mapView.mapView.annotations) // 이전의 모든 주석 제거
//        for todo in allTodoList {
//            if let latitude = todo.placeAlarm?.latitude, let longitude = todo.placeAlarm?.longitude {
//                let pin = ColoredAnnotation()
//                pin.coordinate = CLLocationCoordinate2D(latitude: latitude, longitude: longitude)
//                pin.title = todo.title
//                pin.pinColor = TDStyle.color.mainTheme // 핀 색상을 기본값이나 특정 색상으로 설정
//
//                mapView.mapView.addAnnotation(pin)
//            }
//        }
